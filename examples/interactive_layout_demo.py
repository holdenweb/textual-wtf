...
class InteractiveDemoApp(App):
    ...
    def rebuild_form(self) -> None:
        ...
        self.current_form = DemoForm(initial=old_data)
        ...
        if self.current_form.field_container_defaults.get('help_style') == 'tooltip':
            for bound_field in self.current_form._bound_fields.values():
                if bound_field.field.help_text and bound_field.widget:
